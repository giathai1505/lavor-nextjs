        ...
        <div className="grid grid-cols-4 gap-10 wrapper">
          <div className="col-span-3 flex flex-col gap-5">
            ...
            <p className="text-white">
              ...
              type specimen book. <br /> It has survived not only five
              ...
              uncover many web sites still in their infancy. <br /> Various
              ...
              section 1.10.32. <br /> The standard chunk of Lorem Ipsum used
